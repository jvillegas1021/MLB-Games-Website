...
calculate_betting_logic <- function(matchup_df) {
  betting_df <- matchup_df %>%
    mutate(
      ...
      Bet_Team_Favorite_Underdog_Current = case_when(
        Bet_Team_Current == Favorite_Current ~ "Favorite",
        Bet_Team_Current == Underdog_Current ~ "Underdog",
...
create_final_display_matchup_df <- function(matchup_df) {
    ...
    matchup_display_df <- matchup_df %>%
        select(
            ...
            Home_Team_Losses,
            Home_Team_Open_Odds,
            Home_Open_Win_Probability,
            Home_Team_Current_Odds,
            Home_Current_Win_Probability,
            Home_Team_Model_Odds,
            Home_Team_Model_Win_Probability,
            Home_Team_Open_Edge,
            Home_Team_Current_Edge,
            Home_Pitcher,
            Home_Pitcher_ID,
            Home_Pitcher_Hand,
            Home_Pitcher_Wins,
            ...
            Away_Team_Losses,
            Away_Team_Open_Odds,
            Away_Open_Win_Probability,
            Away_Team_Current_Odds,
            Away_Current_Win_Probability,
            Away_Team_Model_Odds,
            Away_Team_Model_Win_Probability,
            Away_Team_Open_Edge,
            Away_Team_Current_Edge,
            Away_Pitcher,
            Away_Pitcher_ID,
            Away_Pitcher_Hand,
            Away_Pitcher_Wins,
            ...
            Bet_Team_Favorite_Underdog_Current
        ) %>%
...
calculate_total_scores_testing <- function(matchup_df) {
  ...
  matchup_df <- matchup_df %>%
    mutate(
      # HIGH importance 1
      Home_Pitcher_Score = Home_Pitcher_Score * 0.6,
